...
[#if page.pages > 1]
	<div class="pagination">
		...
		[/#if]
		<span class="pageSkip">
			${message("admin.page.totalPages", totalPages)} ${message("admin.page.pageNumber", '<input id="pageNum" name="pageNum" value="' + pageNumber + '" maxlength="9" onpaste="return false;" />')}<button type="submit">&nbsp;</button>
		</span>
	</div>
[/#if]