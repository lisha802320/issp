...
<title>${message("admin.role.edit")} - CMSZ</title>
<meta name="author" content="teamsun++ Team" />
<meta name="copyright" content="teamsun++" />
...
<body>
	...
	<form id="inputForm" action="update.do" method="post">
		...
		<table class="input">
			...
			<tr class="authorities">
				<th>
					<a href="javascript:;" class="selectAll" title="${message("admin.role.selectAll")}">${message("admin.system.mopai")}</a>
				</th>
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:mopaibase"
							[#if role.authorities?seq_contains("admin:mopaibase")] checked="checked"[/#if]
							 />${message("admin.system.mopai.base")}
						</label>
					</span>
				</td>
			</tr>
			<tr class="authorities">
				<th>
					<a href="javascript:;" class="selectAll" title="${message("admin.role.selectAll")}">${message("admin.system.energybar")}</a>
				</th>
				<td>
					<span class="fieldSet">
						<label>																	
							<input type="checkbox" name="authorities" value="admin:energyBarContent" 
								[#if role.authorities?seq_contains("admin:energyBarContent")] checked="checked"[/#if]
							/>${message("admin.system.energybar.content")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:energyBarCoupon" 
							[#if role.authorities?seq_contains("admin:energyBarCoupon")] checked="checked"[/#if]
							/>${message("admin.system.energybar.coupon")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:energyBarOrder" 
							[#if role.authorities?seq_contains("admin:energyBarOrder")] checked="checked"[/#if]
							/>${message("admin.system.energybar.order")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:energyBarCustomer"
							[#if role.authorities?seq_contains("admin:energyBarCustomer")] checked="checked"[/#if]/> 
							${message("admin.system.energybar.customer")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:energyBarMechanic"
							[#if role.authorities?seq_contains("admin:energyBarMechanic")] checked="checked"[/#if]
							 />${message("admin.system.energybar.mechanic")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:energyBarAdmin" 
							[#if role.authorities?seq_contains("admin:energyBarAdmin")] checked="checked"[/#if]
							/>${message("admin.system.energybar.admin")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:energyBarPaidmoney" 
							[#if role.authorities?seq_contains("admin:energyBarPaidmoney")] checked="checked"[/#if]
							/>${message("admin.system.energybar.paidmoney")}
						</label>
					</span>
				</td>
			</tr>
			<tr class="authorities">
				<th>
					<a href="javascript:;" class="selectAll" title="${message("admin.role.selectAll")}">Top1</a>
				</th>
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:energyBarTopOrder"
							[#if role.authorities?seq_contains("admin:energyBarTopOrder")] checked="checked"[/#if]
							 />订单查询
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:energyBarTopPush"
							[#if role.authorities?seq_contains("admin:energyBarTopPush")] checked="checked"[/#if]
							 />下载APP注册查询
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:energyBarTopStatistics"
							[#if role.authorities?seq_contains("admin:energyBarTopStatistics")] checked="checked"[/#if]
							 />门店业务发展统计
						</label>
					</span>
				</td>
			...
			<tr>
				...
				<td>
					...
					<input type="button" class="button" value="${message("admin.common.back")}" onclick="location.href='list.do'" />
				</td>
			</tr>
		</table>
	</form>
