...
<title>${message("admin.role.add")} - CMSZ</title>
		...
		<table class="input">
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:mopaibase" />${message("admin.system.mopai.base")}
						</label>
					</span>
				</td>
			</tr>
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
					<label>
							<input type="checkbox" name="authorities" value="admin:energyBarContent" />${message("admin.system.energybar.content")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:energyBarCoupon" />${message("admin.system.energybar.coupon")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:energyBarOrder" />${message("admin.system.energybar.order")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:energyBarCustomer" />${message("admin.system.energybar.customer")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:energyBarMechanic" />${message("admin.system.energybar.mechanic")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:energyBarAdmin" />${message("admin.system.energybar.admin")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:energyBarPaidmoney" />${message("admin.system.energybar.paidmoney")}
						</label>
					</span>
				</td>
			</tr>
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:energyBarTopOrder" />订单查询
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:energyBarTopPush" />下载APP注册查询
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:energyBarTopStatistics" />门店业务发展统计
						</label>
					</span>
				</td>
			</tr>
